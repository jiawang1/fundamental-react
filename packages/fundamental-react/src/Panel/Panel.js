...
export const Panel = props => {
  ...
  return (
    <div className={`fd-panel${colSpan ? ` fd-has-grid-column-span-${colSpan}` : ''}${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelGrid = props => {
  ...
  return (
    <div className={`fd-panel-grid${nogap ? ' fd-panel-grid--nogap' : ''}${cols ? ` fd-panel-grid--${cols}col` : ''}${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelBody = props => {
  ...
  return (
    <div className={`fd-panel__body${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelHeader = props => {
  const { children, className, ...rest } = props;
  return (
    <div className={`fd-panel__header${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelActions = props => {
  const { children, className, ...rest } = props;
  return (
    <div className={`fd-panel__actions${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelContent = props => {
  const { children, className, ...rest } = props;
  return (
    <div className={`fd-panel__content${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
...
export const PanelFooter = props => {
  const { children, className, ...rest } = props;
  return (
    <div className={`fd-panel__footer${className ? ` ${className}` : ''}`} {...rest}>
      {children}
    </div>
  );
};
