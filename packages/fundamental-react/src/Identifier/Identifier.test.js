...
describe('<Identifier />', () => {
  ...
  const circle = <Identifier size="m" glyph="washing-machine" modifier="circle" />;
  const transparent = <Identifier glyph="washing-machine" className="blue" modifier="transparent" size="m" />;
  const accentColor = <Identifier size="m" glyph="money-bills" color={9} />;

  const bgImage = <Identifier backgroundImageUrl="https://placeimg.com/400/400/nature" modifier="circle" />;
