...
import { Image, Popover, Button, Menu, MenuItem, Table } from '@jay.wang/fundamental-react';
...
/>`;
  ...
  return (
    <div>
      ...
      <h2>Rich Table</h2>
      <Description>
        This is an example of a table with rich cells. The checkbox input can be used at the beginning of each row to allow for bulk actions.When more than three actions exist per
        row and/or space doesn’t allow for actions, a contextual menu can be substituted in order to display all actions in one menu.
      </Description>
      <DocsTile>
        <Table
          headers={[<input type="checkbox" />, 'Avatar', 'email', 'First Name', 'Last Name', 'Date', ' ']}
