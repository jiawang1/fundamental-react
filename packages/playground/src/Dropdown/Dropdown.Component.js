...
import { Dropdown, Popover, Button, Menu, MenuItem } from '@jay.wang/fundamental-react';
...
<Dropdown standard>
  ...
  return (
    <div>
      ...
      <Properties type="Inputs" properties={[{ name: 'standard', description: "bool - set to 'true' to enable a dropdown for toolbar." }]} />
