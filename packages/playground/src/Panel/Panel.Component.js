    ...
    <div>
      ...
      <Properties
        ...
        properties={[
          {
            name: 'nogap',
            description: 'bool - When set to true removes the margins between the panels. Used with <PanelGrid /> component.'
          },
          {
            name: 'cols',
          ...
          {
            name: 'colSpan',
            description: 'number - The number of column grid. Option ranges from 2 to 6. Used with <Panel /> component.'
          },
          {
            name: 'title',
      ...
      <Properties
        ...
        properties={[
          ...
          {
            name: 'PanelFilters',
            description: 'Panel level filters that is specific to the data being displayed within the panel.'
          },
          {
            name: 'PanelContent',
            description: 'Main content of the panel can that hold lists, table, tree, text, form or any other infomation.'
          },
          {
            name: 'PanelFooter',
            description: 'Panel footer can be utilized for pagination, secondary actions, add more data, etc.'
          }
        ]}
      />
